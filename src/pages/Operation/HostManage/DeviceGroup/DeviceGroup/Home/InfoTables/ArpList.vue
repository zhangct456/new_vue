<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="name" label="ARP表物理地址"></el-table-column>
      <el-table-column prop="name" label="ARP表IP地址"></el-table-column>
      <el-table-column prop="name" label="ARP表类型"></el-table-column>
    </el-table>
  </div>
</template>
